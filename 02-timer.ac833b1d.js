...
})({"bj5qG":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "a89a6191ac833b1d";
...
},{}],"2XLM7":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const flatpickrInstance = (0, _flatpickrDefault.default)(dateTimePicker, options);
    ...
    startButton.addEventListener("click", ()=>{
        const selectedDate = flatpickrInstance.selectedDates[0];
        if (selectedDate) startCountdown(selectedDate);
    });
    function startCountdown(targetDate) {
        ...
        countdownInterval = setInterval(()=>{
            ...
            if (timeLeft <= 0) {
                clearInterval(countdownInterval);
                updateTimer(0, 0, 0, 0);
                (0, _notiflixDefault.default).Notify.Success("Countdown completed!");
                return;
            }
...
},{}]},["bj5qG","2XLM7"], "2XLM7", "parcelRequired7c6")

//# sourceMappingURL=02-timer.ac833b1d.js.map
